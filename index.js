    ...
    exec(`curl -o ${audioPath} "${audio}"`, (audioError) => {
        ...
        const procesarRender = () => {
            ...
            if (subtitles && fs.existsSync(vttPath)) {
                filterComplex += `[v_base]subtitles='${vttPath}':force_style='Fontname=DejaVuSans-Bold,Fontsize=18,PrimaryColour=&H00FFFF&,OutlineColour=&H000000&,BorderStyle=1,Outline=3,Alignment=2,MarginV=850'[v_subbed];`;
